...
- [ ] Instalar dependencias: Radix UI, lucide-react, recharts, date-fns, clsx, tailwind-merge, framer-motion
- [ ] Crear estructura de carpetas Clean Architecture
- [ ] Configurar Tailwind con colores personalizados (zinc + emerald)
- [ ] Crear utilidad `cn` (tailwind-merge + clsx)
- [ ] Crear branch `feature/setup` desde `develop`
...
// turbo
- [ ] Crear branch `feature/domain` desde `develop`
- [ ] Definir entidades: `Transaction`, `Category`, `Budget`
...
- [ ] Commits atómicos por cada cambio lógico
- [ ] Merge a `develop`

### Fase 3: Datos Mockeados 💾

- [ ] Crear branch `feature/mock-data` desde `develop`
...
- [ ] Crear branch `feature/ui-base` desde `develop`
...
- [ ] Crear branch `feature/dashboard` desde `develop`
...
- [ ] Crear branch `feature/transactions` desde `develop`
- [ ] Página lista completa con filtros
- [ ] Formulario modal para agregar/editar (usando Radix Dialog)
...
- [ ] Crear branch `feature/categories` desde `develop`
...
- [ ] Crear branch `feature/polish` desde `develop`
- [ ] Animaciones con Framer Motion (fade, slide)
- [ ] Toasts para feedback de acciones (usando Radix Toast)
- [ ] Estados de carga skeleton
- [ ] Hover effects en cards y botones
- [ ] Transiciones suaves entre páginas
- [ ] Commits atómicos
- [ ] Merge a `develop`
- [ ] Merge `develop` → `main` y tag `v1.0.0-mvp`
...
| **Estilo** | TailwindCSS + zinc base + emerald accent |
...
2. **CRUD transacciones** con formulario modal (Radix Dialog)
...
- **Radix UI**: Usar primitivos de Radix para Dialog, Dropdown, Select, Tabs, Popover, Toast
